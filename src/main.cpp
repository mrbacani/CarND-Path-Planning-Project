      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          bool too_close = false; // True if too close to a car in front
					double vehicle_ahead_threshold = 25.0;
					double vehicle_behind_threshold = 15.0;
					...
					double middle_lane_distance = 0.0;
					double right_lane_distance = 0.0;

					// Implmenting weights for each decision
					double switch_lane = 5;
					double stay_lane = 5;
          ...
          for (int i = 0; i < sensor_fusion.size(); i++) {
              ...
              if (check_car_s > car_s && (check_car_s - car_s) < 30){
                //ref_vel = 29.5;
					...
					*/
					...
					// TODO: Run cost functions in this for loop
					for (int i = 0; i < sensor_fusion.size(); i++) {
	          float d = sensor_fusion[i][6];
	          double vx = sensor_fusion[i][3];
	          double vy = sensor_fusion[i][4];
            ...
            check_car_s += (double)prev_size * 0.02 * check_speed;
						...
						// Implement state machine using if else statements
	          if (d >= 0 && d < 4) {
